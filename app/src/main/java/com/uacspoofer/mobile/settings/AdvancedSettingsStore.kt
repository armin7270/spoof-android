...
data class AdvancedSettingsData(
 ...
 val domainStrategy:String="UseIPv4",val routingDomainStrategy:String="AsIs",val ipv4Only:Boolean=true,val keepAliveIdleSeconds:Int=11,val keepAliveIntervalSeconds:Int=15,val blockUdp443:Boolean=false,
...
data class AdvancedSettings(val server:String="104.18.1.1",val port:String="443",val protocol:String="trojan",val password:String="humanity",val transport:String="ws",val security:String="tls",val sni:String="www.ignitelimit.com",val wsHost:String="www.ignitelimit.com",val wsPath:String="/assignment",val alpn:String="http/1.1",val fingerprint:String="chrome",val packets:String="tlshello",val fragmentLength:String="5",val fragmentDelay:String="0",val maxSplit:String="2",val domainStrategy:String="UseIPv4",val keepAliveIdle:String="11",val keepAliveInterval:String="15",val mtu:String="1280",val dns:String="1.1.1.1",val route:String="0.0.0.0/0",val mux:Boolean=false,val blockUdp443:Boolean=false,val socksUdp:Boolean=true)
